...
class AdapterTwoClass(private val dataList: ArrayList<DataClass>): RecyclerView.Adapter<AdapterTwoClass.ViewHolderClass>() {
    ...
    override fun onBindViewHolder(holder: ViewHolderClass, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            it.findNavController().navigate(R.id.action_categoryTwoFragment_to_twoDetailsFragment, bundle)
        }
