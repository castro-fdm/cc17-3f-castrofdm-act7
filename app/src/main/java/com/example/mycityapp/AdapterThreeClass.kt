...
class AdapterThreeClass(private val dataList: ArrayList<DataClass>): RecyclerView.Adapter<AdapterThreeClass.ViewHolderClass>() {
    ...
    override fun onBindViewHolder(holder: ViewHolderClass, position: Int) {
        ...
        holder.itemView.setOnClickListener {
            ...
            it.findNavController().navigate(R.id.action_categoryThreeFragment_to_threeDetailsFragment, bundle)
        }
